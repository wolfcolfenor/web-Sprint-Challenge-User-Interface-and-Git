...
Semantic HTML is HTML that causes a meaningful change to your website

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block puts everything on its own line and display inline does not.  Display inline uses space as needed, Display block uses the full width.
...
It allows collaboration with out editing the original code
